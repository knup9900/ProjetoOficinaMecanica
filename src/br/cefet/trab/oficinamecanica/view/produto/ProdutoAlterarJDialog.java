...
public class ProdutoAlterarJDialog extends javax.swing.JDialog {
    ...
    public ProdutoAlterarJDialog(java.awt.Frame parent, boolean modal, int cdProduto) {
        ...
        try{
            ...
            this.produto = d.consultarPorCod(cdProduto);
            
            jTextField5.setText(produto.getCdproduto()+"");
            jTextField1.setText(produto.getNome());
            String precostr = produto.getPreco()+"";
            precostr = precostr.replace(".", ",");
            jTextField2.setText(precostr);
            jTextField3.setText(produto.getQuantidade()+"");

            
        } catch(Exception e){
            JOptionPane.showMessageDialog(this, "Erro ao consultar Produto("+cdProduto+"): " + e.getMessage(), "Erro ao consultar Produto", JOptionPane.ERROR_MESSAGE);
        }
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 305, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        p.setCdproduto(Integer.parseInt(jTextField5.getText()) );
        p.setNome(jTextField1.getText());
        String precostr = jTextField2.getText();
        precostr = precostr.replace(",", ".");
        p.setPreco(Double.parseDouble(precostr) );
        p.setQuantidade(Integer.parseInt(jTextField3.getText()) );
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Produto alterada com sucesso.");
            
            this.setVisible(false);
            this.dispose();
        } catch (DaoException e) {
            JOptionPane.showMessageDialog(this, "Erro ao alterar Produto:- " +e.getMessage(), "Erro de alteração", JOptionPane.ERROR_MESSAGE);
        } catch (Exception ex) {
            Logger.getLogger(ProdutoAlterarJDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
